      ...
      >
        ...
        <div className="bg-card border border-card-border rounded-2xl shadow-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-card border border-card-border hover:bg-background text-foreground font-medium py-3.5 px-4 rounded-xl transition-all hover:shadow-md"
          >
