      ...
      >
        ...
        <div className="bg-card border border-card-border rounded-2xl shadow-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-card border border-card-border hover:bg-background text-foreground font-medium py-3 px-4 rounded-xl transition-all"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-background border border-input-border rounded-xl text-sm placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-input-focus/30 focus:border-input-focus transition-all"
                required
              />
            </div>
            <div>
